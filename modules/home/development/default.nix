...
in {
  ...
  options.mars.dev = {
    ...
    ide = {
      ...
      cursor = mkEnableOption "Enable Code Cursor" // {default = false;};
      zed = mkEnableOption "Enable Zed Editor" // {default = false;};
      pycharm = mkEnableOption "Enable JetBrains Pycharm" // {default = false;};
    };
    ia = {
      opencode = mkEnableOption "Enable OpenCode" // {default = false;};
    };
    flash = {
